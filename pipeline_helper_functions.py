...
def combining_all_thresholds(gradx, grady, mag_binary, dir_binary):
...
def pipeline_color_thresholding(img, s_thresh=(170, 255), sx_thresh=(20, 100)):
    img = np.copy(img)
...
###==================================================
# Just following implementation in lecture Quiz section
...
# Fit a polynomial after sliding window search
def fit_polygon(binary_warped, leftx, lefty, rightx, righty):
    # Find our lane pixels first
    #leftx, lefty, rightx, righty, out_img = get_sliding_windows(binary_warped)
...
def visualize_sliding_windows(binary_warped, leftx, lefty, rightx, righty, out_img):
...
def get_smooth_lanePixels(binary_warped, margin, left_fit, right_fit):
    ...
    return left_lane_inds, right_lane_inds, nonzeroy, left_fitx, right_fitx, ploty

def visualize_smooth_lanePixels(binary_warped, margin, left_lane_inds, right_lane_inds, nonzeroy, 
